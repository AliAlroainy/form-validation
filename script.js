    ...
    var firstNameValidation=function(){
       ...
       if(firstNameValue=="")
       {
        ...
        firstNameErr.innerHTML=" Name must be only string without white spaces";
         ...
         firstNameErr.innerHTML=" Name must be  string more than 3 and less than 10";
       }else{
    ...
    var areaValidation=function(){
       ...
       if(areaValue=="")
       {
        areaErr.innerHTML=" messege is required";
         ...
         areaErr.innerHTML=" massege must be  string more than 20 ";
       }else{
         areaErr.innerHTML="";
         return true;
       ...
       emailAddressValidation();
         ...
         var ageValidation = function(){
            ...
            if(ageValue=="")
            {
                ...
                ageErr.innerHTML="age most be bigger than 18";
